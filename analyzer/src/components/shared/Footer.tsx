        ...
        <div>
            <footer className="bg-black rounded-lg shadow dark:bg-gray-900 m-4 text-white">
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    ...
                    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© {getYear(Date.now())} <a href="/" className="hover:underline">TokenView™</a>. All Rights Reserved.</span>
                </div>
            </footer>
